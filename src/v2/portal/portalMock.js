...
export const PORTAL_MOCK = {
  ...
  campaigns: [
    {
      // Campanha NO AR: exercita o investido até hoje (CPM/CPCV to date).
      short_token: "PPAY00",
      share_id: "Zp4xN8qLm2vR0kTa",
      campaign_name: "PicPay · Pix Parcelado — Setembro",
      start_date: "2026-09-15",
      end_date: "2026-10-11",
      d_client_budget: 200000,
      v_client_budget: 60000,
      d_invested_to_date: 50400,
      v_invested_to_date: 15640,
      viewable_impressions: 3_580_000,
      display_impressions: 3_500_000,
      video_impressions: 80_000,
      clicks: 29_800,
      display_clicks: 27_300,
      video_clicks: 2_500,
      completions: 68_000,
      ctr: 0.73,
      display_ctr: 0.78,
